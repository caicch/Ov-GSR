...
def bbx_to_sem(sam, bbx, img):
    if sam == 'sam':
        sam_checkpoint = '/mnt/data/SWIG/open_SU_ckpt/ckpt/sam/sam_vit_h_4b8939.pth'
        model_type = 'vit_h'
        sam = sam_model_registry[model_type](checkpoint=sam_checkpoint)
    elif sam == 'mobilesam':
        checkpoint = torch.load('/mnt/data/SWIG/open_SU_ckpt/ckpt/sam/mobile_sam.pt')
        sam = setup_model()
...
def get_args_parser():
    ...
    parser.add_argument('--swig_path', type=str, default="/mnt/data/SWIG")
    parser.add_argument('--image_path', default='/mnt/data/SWIG/images_512/scraping_73.jpg',
    ...
    parser.add_argument('--saved_model', default='OpenSU/checkpoint_max.pth',
